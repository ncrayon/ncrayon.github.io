function CLevel(iLevel, iGoalScored, oContainer){
    ...
    this.viewNextLevelPanel = function(){
        ...
        _oCongratulationTextStroke = new createjs.Text("FELICIDADES!! "," 60px "+TEXT, "#000000");
        ...
        _oCongratulationText = new createjs.Text("FELICIDADES!! "," 60px "+TEXT, "#ffe51f");
        ...
        _oGoalScoredTextStroke = new createjs.Text("GOLES ANOTADOS: "," 40px "+TEXT, "#000000");
        ...
        _oGoalScoredText = new createjs.Text("GOLES ANOTADOS: "," 40px "+TEXT, "#ffe51f");
