			...
			React.createElement("div", {className: "modal", style: styleModal}, 
				React.createElement("div", {className: "wrapper-modal"}, 
					React.createElement("section", {className: "md-head"}, 
						...
						React.createElement("a", {onClick: this.props.hideEvent, className: "close close-modal fa fa-times"})
					), 
		...
		return (
			React.createElement("div", {className: "rows"},  
				React.createElement("div", {className: "columns grid-12 wrapper"}, 
					React.createElement("section", {id: "left-videos-button", onMouseEnter: this.moveLeft, onMouseLeave: this.destroyInterval, className: "side left"}, React.createElement("i", {className: "fa fa-chevron-left"})), 
					React.createElement(YoutubeVideos, {items: this.state.items, fnClick: this.showModal}), 
					React.createElement("section", {id: "right-videos-button", onMouseEnter: this.moveRight, onMouseLeave: this.destroyInterval, className: "side right"}, React.createElement("i", {className: "fa fa-chevron-right"}))	
				), 
