function CNextLevel(){
	...
	this._init = function(){
		...
		_oMsgText = new createjs.Text(TEXT_LEVELCOMPLETED,"48px walibi0615bold", "#fff");
		...
		_oMatchTextScore = new createjs.Text(TEXT_MATCH_SCORE,"30px walibi0615bold", "#fff");
		...
		_oMsgTimeScore = new createjs.Text(TEXT_TIMEBONUS,"30px walibi0615bold", "#fff");
		...
		_oMsgLevelScore = new createjs.Text(TEXT_LEVEL_SCORE,"34px walibi0615bold", "#fff");
		...
		_oMsgTotalScore = new createjs.Text(TEXT_TOTALSCORE,"48px walibi0615bold", "#fff");
		...
		_oContinueButton =  new CTextButton(CANVAS_WIDTH/2,580,
    ...
    this.display = function(iMatchScore,iTimeBonus,iLevelScore,iTotalScore,iLevel){
		...
		$(s_oMain).trigger("end_level",[iLevel,iLevelScore,iTotalScore]);
    };
