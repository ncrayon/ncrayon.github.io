<?php
    /*
    Plugin Name: CTL Arcade - Puzzle Deluxe
    Plugin URI: http://www.codethislab.com/
    Description: Puzzle Deluxe for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadePuzzleDeluxe {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-puzzle-deluxe";
        private $_szPluginName              = "Puzzle Deluxe";
        private $_szAspectRatio             = "16:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "board game, brain game, find image, html5 board game, image, memory, slide, slide 15, tile, tiles";
    ...
    $g_oCTLArcadePuzzleDeluxe =  new CTLArcadePuzzleDeluxe();